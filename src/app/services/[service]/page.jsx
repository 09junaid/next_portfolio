...
import { FaHtml5, FaCss3, FaJs,FaBootstrap , FaReact, FaNodeJs, FaDatabase, FaServer, FaCode,FaPython ,FaGithub  } from "react-icons/fa";
import { GrMysql } from "react-icons/gr";

import { SiMui,SiTailwindcss,SiTypescript,SiShadcnui,SiExpress ,SiNestjs,SiMongodb ,SiPostgresql ,SiSwagger ,SiPostman ,SiJest ,SiWebstorm ,SiSublimetext } from "react-icons/si";
...
const serviceConfig = {
    ...
    technologies: [
      ...
      },
      {
        ...
        technologies: [
          ...
          { name: "Boostrap", icon: <FaBootstrap />, description: "Responsive UI components" },
  ...
  "backend": {
    ...
    description: "Building robust server-side solutions with scalable architecture and secure APIs.",
    technologies: [
      {
      ...
      },
      {
        ...
        technologies: [
          ...
          { name: "MySQL", icon: <GrMysql />, description: "Reliable database system" },
  ...
  "fullstack": {
    ...
    description: "End-to-end web development from frontend to backend, creating complete web applications.",
    technologies: [
      {
        category: "Frontend",
        technologies: [
          { name: "React", icon: <FaReact />, description: "Modern UI components" },
          { name: "HTML/CSS", icon: <FaHtml5 />, description: "Structure and styling" },
          { name: "JavaScript", icon: <FaJs />, description: "Interactive functionality" },
           { name: "TypeScript", icon: <SiTypescript />, description: "Static typing" },
           { name: "Next.js", icon: <RiNextjsFill />, description: "Full-stack React framework" },
          { name: "Boostrap", icon: <FaBootstrap />, description: "Responsive UI components" },
          { name: "Tailwind CSS", icon: <SiTailwindcss />, description: "Utility-first CSS framework" },
      ...
      },
      {
        category: "Backend",
        technologies: [
          { name: "Node.js", icon: <FaNodeJs />, description: "Server-side runtime" },
          { name: "Express", icon: <FaCode />, description: "API framework" },
          { name: "Nest.js", icon: <SiNestjs />, description: "Progressive Node.js framework" },
          { name: "Databases", icon: <FaDatabase />, description: "Data storage solutions" },
      ...
      },
      {
        ...
        technologies: [
          ...
          { name: "Deployment", icon: <FaServer />, description: "Cloud hosting" },
          { name: "Testing", icon: <SiJest />, description: "Quality assurance" },
        ]
      },
      {
        category: "Editors",
    ...
    return (
      <div className="min-h-[80vh] section-padding flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/services" className="text-accent hover:text-white transition-colors">
            Back to Services
          </Link>
        </div>
      </div>
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-accent/10 to-white/5 border border-accent/20 rounded-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-white/80">
            <ul className="space-y-3">
              {serviceData.deliverables.slice(0, Math.ceil(serviceData.deliverables.length / 2)).map((item, index) => (
            ...
            <ul className="space-y-3">
              {serviceData.deliverables.slice(Math.ceil(serviceData.deliverables.length / 2)).map((item, index) => (
                <li key={index} className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-accent rounded-full"></div>
                  <span>{item}</span>
                </li>
